...
def solution_B4():
    ...
    # YOUR CODE HERE
    # Using "shuffle=False"
    training_sentences, validation_sentences = train_test_split(bbc['text'],
                                                                shuffle = False,
                                                                train_size = training_portion)

    training_labels, validation_labels = train_test_split(bbc['category'],
                                                          shuffle = False,
                                                          train_size = training_portion)
    ...
    model.fit(padded_training, train_label_seq,
              epochs = 300, validation_data = (padded_validation, val_label_seq),
              callbacks = [callbacks])
